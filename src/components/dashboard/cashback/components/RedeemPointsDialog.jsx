                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <Input
                                ...
                                placeholder="0"
                                className={cn("pl-3 pr-10 font-semibold h-10", error && "border-red-500 focus-visible:ring-red-500")}
                                autoFocus
                            />
                            <div className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 font-medium text-xs pointer-events-none">pts</div>
                        </div>
                    </div>
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            className="text-sm font-sans h-10"
                        />
                    </div>
                </div>
                {error && (
