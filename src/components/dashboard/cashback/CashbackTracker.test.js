...
const SAMPLE_CARDS = [
    { id: 'c1', name: 'Cash Card', bank: 'Bank A', overallMonthlyLimit: 100, statementDay: 20, tier1PaymentType: 'M+1', tier2PaymentType: 'M+1' },
    { id: 'c2', name: 'Points Card', bank: 'Bank B', overallMonthlyLimit: 0, statementDay: 15, tier1PaymentType: 'Points', tier2PaymentType: 'Points' },
];
